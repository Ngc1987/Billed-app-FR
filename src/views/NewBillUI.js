            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" class="form-control blue-border" data-testid="file" id="onlyImage" />
                  </div>
                  <span id="error">Veuillez télécharger une pièce jointe ayant une extension jpeg, jpg ou png</span>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
